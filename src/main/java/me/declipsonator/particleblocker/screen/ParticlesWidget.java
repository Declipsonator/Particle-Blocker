...
public class ParticlesWidget extends ElementListWidget<ParticlesWidget.Entry> {
    ...
    public ParticlesWidget(ParticlesScreen parent, MinecraftClient client) {
        ...
        this.parent = parent;
        ArrayList<Identifier> particles = new ArrayList<>(Registry.PARTICLE_TYPE.getIds());
    ...
    public class ParticleEntry extends Entry {
        ...
        ParticleEntry(Identifier particle, Text particleName) {
            ...
            this.editButton = new ButtonWidget(0, 0, 50, 20, particleName, (button) -> Config.changeValue(particle.toString())) {
                protected MutableText getNarrationMessage() {
                    return (MutableText) Text.of("Toggled " + particleName + " " + (Config.getValue(particle.toString()) ? "Off" : "On"));
                }
            };
